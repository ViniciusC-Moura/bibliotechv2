class Emprestimo:
    def __init__(self, id, dt_emprestimo, cpf_usuario, id_exemplar, dt_prazo, dt_devolucao):
        self.set_id(id)
    ...
    def __str__(self):
        return f"{self.__id_exemplar} - {self.__cpf} - {self.__dt_devolucao}"